...
namespace Farm.Repositories
{
    public interface IFarmer_trip_sheetsRepository
    {
        ...
        Dictionary<string, object> SearchFarmer_trip_sheets(int userId, string searchString, int pageNumber, int pageSize, string sortColumn, string sortDirection, bool isColumnSearch = false, string columnName = "", string columnDataType = "", string operatorType = "", string value1 = "", string value2 = "");
